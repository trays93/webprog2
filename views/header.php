<?php 
$menu = ['home' => ['name' => 'Kezdőoldal', 'ref' => '/beadando'],
              'another' => ['name' => 'Aloldal', 'ref' => '/beadando/index/another'],
              'previous' => ['name' => 'Előző sorsolások', 'ref' => '/beadando/previous'],
              'statistics' => ['name' => 'Számstatisztika', 'ref' => '/beadando/statistics']
]
?>
